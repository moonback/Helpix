...
interface RentableItemCardSkeletonProps {
  viewMode: 'grid' | 'list';
}

const RentableItemCardSkeleton: React.FC<RentableItemCardSkeletonProps> = ({ viewMode }) => {
  return (
    <Card className={`bg-white rounded-2xl shadow-sm border border-slate-200 animate-pulse ${
      ...
      <div className="flex items-center justify-between pt-4 border-t border-slate-200">
        <div className="flex items-center space-x-3">
          ...
          <div className="h-10 bg-slate-200 rounded-2xl w-20"></div>
        </div>
...
export default RentableItemCardSkeleton;
